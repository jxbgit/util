...
public abstract class HttpUtils {
    ...
    public static String doPost(String url, Map<String, String> params) throws IOException {
        return doPost(url, params, DEFAULT_CHARSET, null, null);
    }
    ...
    public static String doPost(String url, Map<String, String> params, String charset, Map<String, String> headerMap, Proxy proxy) throws IOException {
        ...
        return _doPost(url, ctype, content, CONNECT_TIMEOUT, READ_TIMEOUT, headerMap, proxy);
    }
    ...
    public static String doPost(String url, String ctype, byte[] content) throws IOException {
        return _doPost(url, ctype, content, CONNECT_TIMEOUT, READ_TIMEOUT, null, null);
    }
    ...
    public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams) throws IOException {
        if (fileParams == null || fileParams.isEmpty()) {
            ...
            return doPost(url, params, fileParams, DEFAULT_CHARSET, CONNECT_TIMEOUT, READ_TIMEOUT, null);
        }
    }
    ...
    public static String doPost(String url, Map<String, String> params, Map<String, FileItem> fileParams, String charset) throws IOException {
        return doPost(url, params, fileParams, charset, CONNECT_TIMEOUT, READ_TIMEOUT, null);
    }
    ...
    public static String doGet(String url, Map<String, String> params, Map<String, String> headerMap, String charset, int connectTimeout, int readTimeout) throws IOException {
        ...
        try {
            String ctype = "application/x-www-form-urlencoded;charset=" + charset;
            String query = buildQuery(params, charset);
            conn = getConnection(buildGetUrl(url, query), Constants.METHOD_GET, ctype, headerMap, null);
            conn.setConnectTimeout(connectTimeout);
            conn.setReadTimeout(readTimeout);
            rsp = getResponseAsString(conn);
        } finally {
