 ...
 * class defines methods {@link #setLineNumber(int)} and
 * {@link #getLineNumber()} for setting and getting the current line number
 * respectively.
 *
 * <p>
 ...
 *
 * <p>
 * A line is considered to be <a name="lt">terminated</a> by any one of a line
...
public class LineNumberReader extends BufferedReader {
    ...
    /**
     * Read a line of text. Whenever a <a href="#lt">line terminator</a> is read
     * the current line number is incremented.
     *
     * @return A String containing the contents of the line, not including any
     *         <a href="#lt">line termination characters</a>, or <tt>null</tt>
     ...
     * @throws IOException
     */
    public String readLine(char[] eolSign) throws IOException {
        synchronized (lock) {
            String l = super.readLine(eolSign);
            if (l != null)
                lineNumber++;
            return l;
        }
